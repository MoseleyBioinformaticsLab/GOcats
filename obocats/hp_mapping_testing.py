...
#biological_process
potential_false_bp_mappings = potential_false_mappings(bp_hp_edges)
all_possible_bp_mappings = all_possible_mappings(all_bp_nodes)

print("-----cellular_component-----")
print("Potentially false 'has part' mappings in cellular_component: ", len(potential_false_cc_hp_mappings))
print("All possible mappings in cellular_component: ", len(all_possible_cc_mappings))
