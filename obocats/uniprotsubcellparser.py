...
def build_subdags(args):
    ...
    tools.json_save(go_translated_dict, os.path.join(uniprot_subcell_results_dir, 'Uniprot_subdag_content_dictionary'))
    tools.json_save(uniprot_multi_root, os.path.join(uniprot_subcell_results_dir, 'Uniprot_multi_root_dictionary'))
