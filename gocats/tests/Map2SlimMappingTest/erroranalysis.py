...
# New analysis: we're looking at how many m2s errors occur across all of GO, not individual sub-ontologies.
full_m2s_errors = erroneous_m2s_tuples(m2s_full_mapping_tuples, gc_full_mapping_tuples)
cc_m2s_errors = erroneous_m2s_tuples(m2s_cc_mapping_tuples, gc_full_mapping_tuples)
mf_m2s_errors = erroneous_m2s_tuples(m2s_mf_mapping_tuples, gc_full_mapping_tuples)
bp_m2s_errors = erroneous_m2s_tuples(m2s_bp_mapping_tuples, gc_full_mapping_tuples)
...
print("Number of correct mappings determined by Map2Slim: ", (len(m2s_cc_mapping_tuples.intersection(gc_full_mapping_tuples))))
...
print("Number of correct mappings determined by Map2Slim: ", (len(m2s_mf_mapping_tuples.intersection(gc_full_mapping_tuples))))
...
print("Number of correct mappings determined by Map2Slim: ", (len(m2s_bp_mapping_tuples.intersection(gc_full_mapping_tuples))))
